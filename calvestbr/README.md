...
## 🔗MODO DE USO
Mover o arquivo CSV 'ranking_universidades' localizado no repositório 'calvestbr' para a pasta que irá rodar o código (https://github.com/Anaczhang/calvestbr/blob/master/calvestbr/ranking_universidades.csv)<br />
